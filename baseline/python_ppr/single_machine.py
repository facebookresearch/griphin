...
parser.add_argument('--num_source', type=float, default=10)
...
def batch_local_push_ppr(g_, target_id_, alpha_, epsilon_, gamma_=1., max_degree_=-1, drop_coe_=0):
    ...
    while True:
        ...
        while True:
            ...
            iteration += 1
            # print('iter:', iteration, ', num activated nodes:', len(v_idx_))
...
if __name__ == '__main__':
    ...
    source_nodes = torch.arange(num_source, dtype=torch.long)
