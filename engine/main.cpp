...
int main(){
    ...
    char p0_edge_weights_file[] = "../../../../data/omer/meta_data/ogbn_products_4partitions/csr_edge_weights_p0.txt";
    ...
    char p1_edge_weights_file[] = "../../../../data/omer/meta_data/ogbn_products_4partitions/csr_edge_weights_p1.txt";
    ...
    char p2_edge_weights_file[] = "../../../../data/omer/meta_data/ogbn_products_4partitions/csr_edge_weights_p2.txt";
    ...
    char p3_edge_weights_file[] = "../../../../data/omer/meta_data/ogbn_products_4partitions/csr_edge_weights_p3.txt";
    ...
    Graph<VertexProp, EdgeProp> shard0(0, p0_ids_file, p0_halo_shards_file, p0_csr_indices_file, p0_csr_shard_indices_file, p0_csr_indptrs_file, p0_edge_weights_file, p0_weighted_degrees_file, partition_book_file);
    Graph<VertexProp, EdgeProp> shard1(1, p1_ids_file, p1_halo_shards_file, p1_csr_indices_file, p1_csr_shard_indices_file, p1_csr_indptrs_file, p1_edge_weights_file, p1_weighted_degrees_file, partition_book_file);
    Graph<VertexProp, EdgeProp> shard2(2, p2_ids_file, p2_halo_shards_file, p2_csr_indices_file, p2_csr_shard_indices_file, p2_csr_indptrs_file, p2_edge_weights_file, p2_weighted_degrees_file, partition_book_file);
    Graph<VertexProp, EdgeProp> shard3(3, p3_ids_file, p3_halo_shards_file, p3_csr_indices_file, p3_csr_shard_indices_file, p3_csr_indptrs_file, p3_edge_weights_file, p3_weighted_degrees_file, partition_book_file);
