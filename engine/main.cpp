...
int main(){
    char p0_ids_file[] = "ogbn_csr_format/p0_ids.txt";
    char p0_halo_shards_file[] = "ogbn_csr_format/p0_halo_shards.txt";
    char p0_csr_indices_file[] = "ogbn_csr_format/csr_indices0.txt";
    char p0_csr_shard_indices_file[] = "ogbn_csr_format/csr_shards0.txt";
    char p0_csr_indptrs_file[] = "ogbn_csr_format/csr_indptr0.txt";

    char p1_ids_file[] = "ogbn_csr_format/p1_ids.txt";
    char p1_halo_shards_file[] = "ogbn_csr_format/p1_halo_shards.txt";
    char p1_csr_indices_file[] = "ogbn_csr_format/csr_indices1.txt";
    char p1_csr_shard_indices_file[] = "ogbn_csr_format/csr_shards1.txt";
    char p1_csr_indptrs_file[] = "ogbn_csr_format/csr_indptr1.txt";

    char p2_ids_file[] = "ogbn_csr_format/p2_ids.txt";
    char p2_halo_shards_file[] = "ogbn_csr_format/p2_halo_shards.txt";
    char p2_csr_indices_file[] = "ogbn_csr_format/csr_indices2.txt";
    char p2_csr_shard_indices_file[] = "ogbn_csr_format/csr_shards2.txt";
    char p2_csr_indptrs_file[] = "ogbn_csr_format/csr_indptr2.txt";

    char p3_ids_file[] = "ogbn_csr_format/p3_ids.txt";
    char p3_halo_shards_file[] = "ogbn_csr_format/p3_halo_shards.txt";
    char p3_csr_indices_file[] = "ogbn_csr_format/csr_indices3.txt";
    char p3_csr_shard_indices_file[] = "ogbn_csr_format/csr_shards3.txt";
    char p3_csr_indptrs_file[] = "ogbn_csr_format/csr_indptr3.txt";
    
    char partition_book_file[] = "ogbn_csr_format/partition_book.txt";
